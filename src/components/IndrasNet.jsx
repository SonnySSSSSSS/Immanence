...
export function IndrasNet() {
    ...
    useEffect(() => {
        ...
        function resize() {
            // Use the actual rendered width of the canvas (constrained by parent)
            // instead of window.innerWidth to prevent squishing
        ...
        >
            ...
            <div
                style={{
                    ...
                    animation: "indrasNetPingPong 150s ease-in-out infinite",
            ...
            <style>{`
        @keyframes indrasNetPingPong {
          0% { background-position-x: 0; }
          25% { background-position-x: 30%; }
          75% { background-position-x: -30%; }
