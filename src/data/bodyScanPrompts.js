...
export const BODY_SCANS = {
    full: {
        ...
        prompts: [
            { point: 'rightFoot', text: "Ground in your right foot...", timing: 0 },
            { point: 'leftFoot', text: "Now your left foot...", timing: 15 },
            { point: 'rightHand', text: "Awareness extends to your right hand...", timing: 30 },
            { point: 'leftHand', text: "Now to your left hand...", timing: 45 },
            { point: 'root', text: "Ground at the base of the spine...", timing: 60 },
            { point: 'sacral', text: "Ascend to the sacral center...", timing: 75 },
            { point: 'solarPlexus', text: "Move to the solar plexus...", timing: 90 },
            { point: 'rightShoulder', text: "Extend awareness to your right shoulder...", timing: 105 },
            { point: 'leftShoulder', text: "Now to your left shoulder...", timing: 120 },
            { point: 'heart', text: "Return to the heart center...", timing: 135 },
            { point: 'throat', text: "Ascend to the throat center...", timing: 150 },
            { point: 'thirdEye', text: "Move to the space between your eyebrows...", timing: 165 },
            { point: 'crown', text: "Bring attention to the crown of your head...", timing: 180 },
        ]
    },
    head: {
        id: 'head',
