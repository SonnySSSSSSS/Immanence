...
const DAY_COPY = [
    {
        ...
        narrative: 'Today establishes the contract. You measure your current breath capacity, then complete the evening focus reset without bargaining.',
        isBenchmark: true,
    },
    {
        title: 'Stability',
    ...
    },
    {
        ...
        narrative: 'The morning breath steadies the system. The evening focus reset trains precise observation.',
    },
    {
        title: 'Rhythm',
    ...
    return DAY_COPY.map((day, index) => {
        ...
        return {
            ...
            legs: [
                ...
                {
                    legNumber: 2,
                    label: 'Evening Focus Reset',
                    practiceType: 'Breath & Stillness',
                    practiceId: 'breath',
                    categoryId: 'breathwork',
                    matchPolicy: MATCH_POLICY.EXACT_PRACTICE,
                    required: true,
                    practiceConfig: {
                        duration: 10,
                        stillness: {
                    ...
                    description: 'Evening focus reset (10 minutes) followed by a 1-minute decompression.',
                    focusArea: 'focus',
                },
            ],
        };
...
export const RITUAL_INITIATION_14_V2 = {
    ...
    duration: 14,
    durationDays: 14,
    description: '14-day initiation contract with morning breath and an evening focus reset.',
    author: 'Immanence OS',
    version: '1.0',
