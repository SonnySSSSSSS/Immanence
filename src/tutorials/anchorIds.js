export const ANCHORS = {
  ...
  WISDOM_VIDEOS_ROOT: 'wisdom-videos-root',
  WISDOM_VIDEOS_HEARTH: 'wisdom-videos-hearth',
  WISDOM_VIDEOS_FEATURED_BAND: 'wisdom-videos-featured-band',
  WISDOM_VIDEOS_LIBRARY_BAND: 'wisdom-videos-library-band',
  WISDOM_SELF_ROOT: 'wisdom-self-root',
  WISDOM_SELF_BIGFIVE_CARD: 'wisdom-self-bigfive-card',
  WISDOM_SELF_BIGFIVE_ACTION: 'wisdom-self-bigfive-action',
  WISDOM_SELF_TAGS: 'wisdom-self-tags',
