import { ANCHORS, tutorialSelector } from './anchorIds.js';
import { PAGE_TUTORIAL_DEFINITIONS, tutorialAnchorTarget } from './pageTutorialDefinitions.js';

export const TUTORIALS = {
  'page:home': PAGE_TUTORIAL_DEFINITIONS['page:home'],
  'page:practice': PAGE_TUTORIAL_DEFINITIONS['page:practice'],
  'page:wisdom': PAGE_TUTORIAL_DEFINITIONS['page:wisdom'],
  'page:application': PAGE_TUTORIAL_DEFINITIONS['page:application'],
  'page:navigation': PAGE_TUTORIAL_DEFINITIONS['page:navigation'],
  ...
  'page:photic-beginner': PAGE_TUTORIAL_DEFINITIONS['page:photic-beginner'],
