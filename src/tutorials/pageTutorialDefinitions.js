...
export const PAGE_TUTORIAL_DEFINITIONS = {
  ...
  'page:practice': {
    ...
    steps: [
      ...
      {
        id: 'practice-global-help',
        title: 'Help Anytime',
        body: 'Use the `?` in the app shell to reopen the current Practice tutorial. It follows the practice you are currently configuring.',
        target: tutorialSelector(ANCHORS.GLOBAL_TUTORIAL_BUTTON),
        placement: 'left',
        allowInteraction: true,
      },
    ...
    steps: [
      {
        id: 'photic-protocol',
        title: 'Protocol',
        body: 'Start with rate and timing. Find a pulse that feels stable before adjusting anything else, and finish that setup before moving on to intensity or color.',
      ...
      },
      {
        id: 'photic-intensity',
        title: 'Intensity',
        body: 'Raise brightness only until the circles are clear and comfortable. If strain appears, reduce intensity and keep the pattern simple. Brightness and color tuning belong here, after the protocol feels stable.',
